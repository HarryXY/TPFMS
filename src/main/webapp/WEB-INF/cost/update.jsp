...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function update(cost){
            	...
            	if(b){
            		location.href="modifyCost.do?cost="+cost;
            	}
            }
        </script>       
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="toModifyCost.do" method="post" class="main_form">
                <div class="text_info clearfix"><span>资费ID：</span></div>
                <div class="input_info"><input name="costId" type="text" class="readonly" readonly value="${cost.costId }" /></div>
                ...
                <div class="input_info fee_type">
                    ...
                    <input type="radio" name="costType" value="2"  ${cost.costType==3?"checked":"" } id="timeBased" onclick="feeTypeChange(3);" />
